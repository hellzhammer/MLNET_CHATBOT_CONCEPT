...
namespace SampleBinaryClassification.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"/home/matt/Desktop/DataSets/GreetingData/mainData.tsv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Greeting} | Predicted value: {predictionResult.Prediction}");
