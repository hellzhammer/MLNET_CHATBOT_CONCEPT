...
namespace KronusLogicProcessor.QuestionStatementLogic
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"/home/matt/Desktop/DataSets/Question_Statement/QuestionStatementData.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SdcaLogisticRegression(labelColumnName: "StatementType", featureColumnName: "Features");
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.BinaryClassification.CrossValidateNonCalibrated(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "StatementType");
