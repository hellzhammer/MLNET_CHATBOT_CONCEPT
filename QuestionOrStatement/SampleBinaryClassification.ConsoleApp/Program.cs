...
namespace SampleBinaryClassification.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"/home/matt/Desktop/DataSets/Question_Statement/QuestionStatementData.tsv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.StatementType} | Predicted value: {predictionResult.Prediction}");
